...
export class BusinessService<Entity extends ObjectLiteral> {
  ...
  async updateById(id: number, updateData: DeepPartial<Entity>, user: User) {
  ...
  async bulkSave(entities: DeepPartial<BusinessEntity>[], user: User) {
  ...
  async bulkSaveTransactional(
    entities: DeepPartial<BusinessEntity>[],
    user: User,
